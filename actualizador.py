...
APPS = [
    ...
    },
    {
        ...
        "extract_file": "shadowmountplus.elf" # <-- Necesario porque el autor ahora sube ZIPs
    },
    {
        "id": "ftpsrv", 
...
# Volvemos a admitir ZIPs para que no salte lanzamientos como el 1.7beta1
...
def main():
    ...
    for app in APPS:
        ...
        if version and url_descarga:
            ...
            # Si el archivo es un .zip y el autor configuró un extract_file, lo añadimos
